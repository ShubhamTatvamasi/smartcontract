...
contract KiepayToken is StdToken
{
/// Fields:
    string public constant name = "Kiepay Token";
...
/// Functions:
    ...
    function KiepayToken(address _tokenManager, address _escrow, address _teamTokenBonus) public
    {
